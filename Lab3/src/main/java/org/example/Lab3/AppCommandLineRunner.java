...
public class AppCommandLineRunner implements CommandLineRunner
{
    ...
    @Autowired
    public AppCommandLineRunner(BookGenreService bookGenreService, BookService bookService)
    {
    ...
    private void addBook(Scanner scanner)
    {
        ...
        try
        {
            ...
            Optional<BookGenre> bookGenreOptional = bookGenreService.findById(bookGenreId);

            if (bookGenreOptional.isPresent())
            {
                BookGenre bookGenre = bookGenreOptional.get();
